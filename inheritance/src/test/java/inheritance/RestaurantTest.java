...
public class RestaurantTest {
    @Test public void testRestaurantConstructor() {
        Restaurant r = new Restaurant("Boiling Point", 4.1, "$$");
        String expected = "Name: Boiling Point, Number of stars: 4.1, Price: $$";
    ...
    @Test public void testAddReview() {
        ...
        String expected = "Name: Minamoto, Number of stars: 4.5, Price: $$";
